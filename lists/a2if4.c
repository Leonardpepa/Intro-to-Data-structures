...
int main(){
    ...
    printf("DWSE TO PLITHOS TWN STOIXEIWN THS LISTAS 1:");
    scanf("%d",&n);
    for(i=0;i<n;i++)
    {
        printf("DWSE AROTHMO GIA EISAGWGH STHN ARXH THS LISTAS 1:");
        scanf("%d",&item);
        LinkedInsert(&list1,item,NULL);
    }

     printf("DWSE TO PLITHOS TWN STOIXEIWN THS LISTAS 2:");
      scanf("%d",&n);
        for(i=0;i<n;i++)
    {
        printf("DWSE AROTHMO GIA EISAGWGH STHN ARXH THS LISTAS 2:");
        scanf("%d",&item);
        LinkedInsert(&list2,item,NULL);
    }


    ListPointer telikilista;
    CreateList(&telikilista);
    tomi(&list1,&list2,&telikilista);
    LinkedTraverse(list1,1);
    LinkedTraverse(list2,2);
    LinkedTraverse(telikilista,0);
...
*/
{
   ...
   else
   {
   	 ...
   	 if(i==1){
   	 printf("*********1i lista*********\n");}
   	 else if(i==2) printf("*********2i lista*********\n");
   	 else printf("*********teliki lista*********\n");
...
void tomi(ListPointer *list1,ListPointer *list2,ListPointer *telikilista){
 ListPointer tempi,tempj;

    boolean flag=TRUE;
    ListPointer currtelikh;
    ...
    tempj=*list2;
     ...
     while(tempj!=NULL){
        ...
        if ((*tempi).Data==(*tempj).Data){
            ...
            currtelikh=*telikilista;

            while(currtelikh!=NULL){

                if((*currtelikh).Data==(*tempi).Data)
                    flag=FALSE;
                currtelikh=(*currtelikh).Next;
            }
            if (flag==TRUE){
              LinkedInsert(telikilista,(*tempi).Data,NULL);
