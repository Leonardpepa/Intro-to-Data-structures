...
int main(){
    ListPointer Alist;
    CreateList(&Alist);
    printf("DWSE TO PLITHOS TWN STOIXEIWN STH LISTA:");
    ListElementType n,item;
    ...
    for(i=0;i<n;i++)
    {
        printf("DWSE STOIXEIW GIA EISAGWGH STHN ARXH THS LISTAS:");
        scanf("%d",&item);
    ...
    printf("DWSE STOIXEIW GIA EISAGWGH STO TELOS THS LISTAS:");
   scanf("%d",&item);
   insert_at_the_end(&Alist,item);
